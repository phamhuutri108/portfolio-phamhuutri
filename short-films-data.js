...
const filmsData = {
    ...
    "short-films-dad-dont-lie-to-me": {
        ...
        `,
        en: `
            <p><b>Genre:</b> Short fiction / Drama, Observation<br><b>Year:</b> Coming-soon 2026</p>
            <div style="text-align: left; margin: 30px 0;">
                <iframe width="100%" height="315" style="max-width: 560px; border-radius: 4px;" src="https://www.youtube.com/embed/ooWID56SmHk" title="Dad, Don't Lie To Me" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            <h3>Logline</h3>
    ...
    "short-films-karma": {
        ...
        vi: `
            <p><b>Thể loại:</b> Phim ngắn / Tâm lý<br><b>Năm:</b> 2024<br><b>Thời lượng:</b> 28:20<br><b>Giải thưởng:</b><br>Cánh Diều Bạc, Hội điện ảnh Việt Nam (2024)<br>Kịch bản xuất sắc nhất - FABA Films (2025)</p>
            <div style="text-align: left; margin: 30px 0;">
            ...
            <ul style="list-style: none; padding-left: 10px; font-size: 12px; line-height: 1.8;">
                ...
                <li>... (các thành viên khác giữ nguyên) ...</li>
            </ul>
            <h3>Behind The Scene</h3>
            <div class="gallery-wall">
        ...
        `,
        en: `
            <p><b>Genre:</b> Short fiction / Drama<br><b>Year:</b> 2024<br><b>Duration:</b> 28:20<br><b>Awards:</b><br>Silver Prize, Golden Kite Awards (2024)<br>Best Screenplay, FABA Films (2025)</p>
            <div style="text-align: left; margin: 30px 0;">
                <iframe width="100%" height="315" style="max-width: 560px; border-radius: 4px;" src="https://www.youtube.com/embed/VzVB9pFBoiY" title="Karma" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    ...
    "short-films-the-ghost-wants-to-live": {
        ...
        vi: `
            <p><b>Thể loại:</b> Phim tài liệu ngắn / Tương tác<br><b>Năm:</b> 2022<br><b>Thời lượng:</b> 22:02</p>
            <div style="text-align: left; margin: 30px 0;">
        ...
        `,
        en: `
            <p><b>Genre:</b> Documentary short / Interactive<br><b>Year:</b> 2022<br><b>Duration:</b> 22:02</p>
            <div style="text-align: left; margin: 30px 0;">
                <iframe width="100%" height="315" style="max-width: 560px; border-radius: 4px;" src="https://www.youtube.com/embed/ijfYdCNMRK8" title="The Ghost Wants to Live" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
            <h3>Synopsis</h3>
    ...
    "short-films-cocks-cooking": {
        ...
        vi: `
            <p><b>Thể loại:</b> Phim ngắn / Tâm lý<br><b>Năm:</b> 2023<br><b>Thời lượng:</b> 06:45</p>
    ...
    "short-films-alive": {
        ...
        vi: `
            <p><b>Thể loại:</b> Phim ngắn / Tâm lý<br><b>Năm:</b> 2020<br><b>Thời lượng:</b> 19:23</p>
            <div style="text-align: left; margin: 20px 0;">
        ...
        `,
        en: `
            <p><b>Genre:</b> Short fiction / Drama<br><b>Year:</b> 2020<br><b>Duration:</b> 19:23</p>
            <div style="text-align: left; margin: 20px 0;">
                <iframe width="100%" height="315" style="max-width: 560px; border-radius: 4px;" src="https://www.youtube.com/embed/QBW1HpOVGz8" title="Alive" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        `
    ...
    "short-films-when-my-city-grows": {
        ...
        vi: `
            <p><b>Thể loại:</b> Phim tài liệu ngắn<br><b>Năm:</b> 2020<br><b>Thời lượng:</b> 02:55</p>
            <div style="text-align: left; margin: 20px 0;">
        ...
        `,
        en: `
            <p><b>Genre:</b> Documentary short<br><b>Year:</b> 2020<br><b>Duration:</b> 02:55</p>
            <div style="text-align: left; margin: 20px 0;">
                <iframe width="100%" height="315" style="max-width: 560px; border-radius: 4px;" src="https://www.youtube.com/embed/9qh9bCoNitI" title="When My City Grows" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        `
